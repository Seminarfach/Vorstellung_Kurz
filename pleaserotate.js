(function(){
    ...
    function setVisibility(visible){
        ...
        if(visible){
            ...
            if(backdropElement){
                ...
                console.log("Kein Overlay gefunden")
            }
        }
    }
    ...
    PleaseRotate.start = function(opts){
        ...
        //console.log(PleaseRotate.Showing)
    ...
    PleaseRotate.stop = function(){
        const backdropElement = document.getElementById("pleaserotate-backdrop");
        if (backdropElement) {
            //console.log("Backdrop-Element gefunden:", backdropElement);
            backdropElement.remove(); // Entfernt das Element vollständig
             // Versuch, das Overlay auszublenden
        } else {
            //console.log("Kein Backdrop-Element gefunden. Overlay wurde möglicherweise nicht erstellt.");
        }
